...
所有主图为白底，坐标与图例字号不低于 12--16 pt，图例和说明位于右上区域；统一使用 `#DDF2F0`、`#D6F6F1`、`#A6EBDD`、`#88C9D0`、`#929ED2`、`#5E8CBE`、`#3E5682`、`#0F1633` 青绿—蓝紫 SCI 色板，并以点形、线型作为冗余编码，避免彩虹色图和仅依赖颜色辨识；PNG 为 600 dpi，PDF 保留矢量文本。图形已经逐张检查，无明显重叠、截断或工具栏残留。
